...
int main(){
	vector<string> jugadores = { "1.Erick", "2.Emmanuel", "3.Briam", "4.Gabriel", "5.Maria", "6.Oscar", "7.Krista", "8.Eduardo", "9.Alejandra", "10.Carlos",
								 "11.Diego", "12.Manuel", "13.Jose", "14.Mateo", "15.Fernando", "16.Martinez", "17.Ernesto", "18.Gustavo", "19.Graham"};
...
void papaCaliente(const vector<string> &listaNombres){
	...
	for (int i = cantidadJugadores; i > 1; i--){
		...
		cout << funado << endl;
		cout << endl << "ALTO!!!"  << endl << endl << funado << " ELIMINADO/A! " << endl ;
		cout << endl << "-------------------------------------------------------------"<< endl << endl;
	}
	string ganador = simulacion.dequeue();
	cout << endl << endl<< ganador << " GANO EL JUEGO!" << endl;
}